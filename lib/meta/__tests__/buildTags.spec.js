...
var SEO = {
  ...
  languageAlternates: [
    { hrefLang: 'de-AT', href: 'https://www.canonical.ie/de' },
    { hrefLang: 'sk-SK', href: 'https://www.canonical.ie/sk' },
  ],
  openGraph: {
    type: 'website',
    locale: 'en_IE',
...
it('renders correctly', function() {
  ...
  it('returns full array for default seo object', function() {
    var a = (0, _buildTags['default'])(SEO),
      ...
      N = c.querySelectorAll('link[rel="alternate"][media]'),
      O = c.querySelectorAll(
        'link[href="'.concat(SEO.mobileAlternate.href, '"]'),
      ),
      P = c.querySelectorAll(
        'link[media="'.concat(SEO.mobileAlternate.media, '"]'),
      );
    expect(Array.from(N).length).toBe(1),
      expect(Array.from(O).length).toBe(1),
      expect(Array.from(P).length).toBe(1);
    var Q = c.querySelectorAll('link[rel="alternate"][hrefLang]');
    expect(Array.from(Q).length).toBe(SEO.languageAlternates.length),
      SEO.languageAlternates.forEach(function(a, b) {
        var d = c.querySelectorAll(
            'link[href="'.concat(SEO.languageAlternates[b].href, '"]'),
          ),
          e = c.querySelectorAll(
            'link[hrefLang="'.concat(SEO.languageAlternates[b].hrefLang, '"]'),
          );
        expect(Array.from(d).length).toBe(1),
          expect(Array.from(e).length).toBe(1);
      }),
      expect(d).toBeDefined(),
      expect(Array.from(e).length).toBe(2),
      expect(Array.from(f).length).toBe(1),
      expect(Array.from(g).length).toBe(1),
      expect(Array.from(i).length).toBe(1),
      expect(Array.from(h).length).toBe(1),
      expect(Array.from(j).length).toBe(1),
      expect(Array.from(k).length).toBe(1),
      expect(Array.from(l).length).toBe(1),
      expect(Array.from(m).length).toBe(1),
      expect(Array.from(n).length).toBe(1),
      expect(Array.from(o).length).toBe(1),
      expect(Array.from(p).length).toBe(1),
      expect(Array.from(q).length).toBe(1),
      expect(Array.from(r).length).toBe(1),
      expect(Array.from(s).length).toBe(1),
      expect(Array.from(t).length).toBe(1),
      expect(Array.from(u).length).toBe(1),
      expect(Array.from(v).length).toBe(1),
      expect(Array.from(w).length).toBe(1),
      expect(Array.from(x).length).toBe(1),
      expect(Array.from(y).length).toBe(1),
      expect(Array.from(z).length).toBe(1),
      expect(Array.from(A).length).toBe(1),
      expect(Array.from(B).length).toBe(1),
      expect(Array.from(C).length).toBe(1),
      expect(Array.from(D).length).toBe(1),
      expect(Array.from(E).length).toBe(6),
      expect(Array.from(F).length).toBe(1),
      expect(Array.from(G).length).toBe(1),
      expect(Array.from(H).length).toBe(1),
      expect(Array.from(I).length).toBe(1),
  ...
  it('correctly sets noindex', function() {
    var a = _objectSpread({}, SEO, { noindex: !0 }),
      ...
      f = d.querySelectorAll('meta[content="noindex,follow"]');
    expect(Array.from(e).length).toBe(0), expect(Array.from(f).length).toBe(2);
  }),
  it('correctly sets nofollow', function() {
    var a = _objectSpread({}, SEO, { nofollow: !0 }),
      b = (0, _buildTags['default'])(a),
      c = (0, _reactTestingLibrary.render)(
        _react['default'].createElement(
          _react['default'].Fragment,
      ...
      d = c.container,
      e = d.querySelectorAll('meta[content="index,follow"]'),
      f = d.querySelectorAll('meta[content="index,nofollow"]');
    expect(Array.from(e).length).toBe(0), expect(Array.from(f).length).toBe(2);
  }),
  it('correctly sets noindex, nofollow', function() {
    var a = _objectSpread({}, SEO, { noindex: !0, nofollow: !0 }),
      b = (0, _buildTags['default'])(a),
      c = (0, _reactTestingLibrary.render)(
        _react['default'].createElement(
          _react['default'].Fragment,
...
it('Video SEO renders correctly', function() {
  ...
  it('additional meta tags are set', function() {
    ...
    expect(Array.from(e).length).toBe(1), expect(Array.from(f).length).toBe(1);
  }),
  it('correctly sets noindex default', function() {
    var a = _objectSpread({}, SEO, { dangerouslySetAllPagesToNoIndex: !0 }),
      b = (0, _buildTags['default'])(a),
      c = (0, _reactTestingLibrary.render)(
        _react['default'].createElement(
          _react['default'].Fragment,
  ...
  it('correctly sets nofollow default', function() {
    var a = _objectSpread({}, SEO, { dangerouslySetAllPagesToNoFollow: !0 }),
      b = (0, _buildTags['default'])(a),
      c = (0, _reactTestingLibrary.render)(
        _react['default'].createElement(
          _react['default'].Fragment,
  ...
  it('correctly read noindex & nofollow false', function() {
    var a = _objectSpread({}, SEO, { noindex: !1, nofollow: !1 }),
      b = (0, _buildTags['default'])(a),
      c = (0, _reactTestingLibrary.render)(
        _react['default'].createElement(
          _react['default'].Fragment,
