...
var _defaultSEO = _interopRequireDefault(require('./meta/defaultSEO')),
  ...
  _faqPage = _interopRequireWildcard(require('./jsonld/faqPage')),
  _jobPosting = _interopRequireWildcard(require('./jsonld/jobPosting')),
  _blog = _interopRequireWildcard(require('./jsonld/blog')),
  _course = _interopRequireWildcard(require('./jsonld/course')),
  _dataset = _interopRequireWildcard(require('./jsonld/dataset')),
  ...
  _newsarticle = _interopRequireWildcard(require('./jsonld/newsarticle')),
  _event = _interopRequireWildcard(require('./jsonld/event')),
